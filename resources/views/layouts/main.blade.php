            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                ...
                @auth()
                    <ul class="navbar-nav mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-outline-primary nav-link mr-3" href="{{route('personal.main.index')}}">Personal Area</a>
                        </li>
                        <li class="nav-item">
                            <form action="{{route('logout')}}" method="post">
                                @csrf
                                <button class="btn btn-outline-primary nav-link" type="submit"><i
