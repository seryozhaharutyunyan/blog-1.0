            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="pone" class="col-md-4 col-form-label text-md-end">{{ __('Pone') }}</label>

                            <div class="col-md-6">
                                <input id="pone" type="text" class="form-control @error('pone') is-invalid @enderror" name="pone" value="{{ old('pone') }}" required autocomplete="pone" autofocus pattern="\+[7]{1}\d{3}\d{3}\d{2}\d{2}">
                        ...
                        <div class="row mb-3">
                            <label for="im" class="col-md-4 col-form-label text-md-end">{{ __('Image') }}</label>
